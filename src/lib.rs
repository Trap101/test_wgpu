...
impl State {
    ...
    async fn new(window: Window) -> Self {
        ...
        //     label: Some("frag"),
        //     source: wgpu::ShaderSource::Glsl{shader:include_str!("frag1.frag").into(),stage:naga::ShaderStage::Fragment,defines:FastHashMap::default()},
        // });        
        // let vertex = device.create_shader_module(wgpu::ShaderModuleDescriptor {
        //     label: Some("vertex"),
        //     source: wgpu::ShaderSource::Glsl{shader:include_str!("vert1.vert").into(),stage:naga::ShaderStage::Vertex,defines:FastHashMap::default()},
        // });        
